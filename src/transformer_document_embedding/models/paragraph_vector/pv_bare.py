...
class PVBare:
    """Just my wrapper for nicer interface."""
    ...
    def __init__(
        ...
        assert (
            len(self.modules) > 0
        ), f"{PVBare.__name__} must be used with DM or DBOW architecture."
    ...
    def load(self, dir_path: str) -> None:
        ...
        assert len(new_modules) > 0, f"{PVBare.load.__name__}: no model found."
