...
Longformer tokens long. We label the resulting dataset as \Dataset{val-500k}
...
are evaluated using a validation split, except for \Task{IMDB}, where we take
...
During training, we aim for fast convergence with a small memory footprint.
...
structural loss as \Model{only-structural;cosine}.
