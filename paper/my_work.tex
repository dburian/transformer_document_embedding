...
% TODO: write here structural is very important and we want to squeeze
% everything there is, on the other hand contextual is here to fill-in the
% context and therefore we need only rough aligning
