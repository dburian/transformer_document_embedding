...
more efficient.
% Maybe we can insert some theory about embedding models such as "Embedding
% models are trained to capture the maximum amount of information while being
% constrained by a fixed sized vector. Consequently, they have to minimise noise
% harmful in the downstream tasks while learning to capture meaning from the
% input."
