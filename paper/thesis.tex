...
\def\Dedication{I want to thank my supervisor for his experienced and
insightful guidance. I am also grateful to my partner and family, who have
kindly supported me during my studies.}

% Abstract (recommended length around 80-200 words; this is not a copy of your
% thesis assignment!)

\def\Abstract{We develop a method to train a document embedding model with an unlabeled
